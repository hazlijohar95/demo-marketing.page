...
function readLang() {
  ...
  return window.localStorage.getItem("bx-qs-lang") === "py" ? "py" : "ts"
}

function CodeBlock({ filename, caption, code, langLabel }) {
...
export default function Quickstart() {
  ...
  useEffect(() => {
    try {
      window.localStorage.setItem("bx-qs-lang", lang)
    } catch {
      ...
      <section data-section="qs-step" id="qs-install" aria-labelledby="qs-install-title">
        <div data-slot="section-header">
          ...
          <Reveal delay={100} data-component="demo-controls">
            <div data-component="scenario-pills" role="group" aria-label="SDK language">
              <button
                type="button"
                data-active={isTs}
                aria-pressed={isTs}
