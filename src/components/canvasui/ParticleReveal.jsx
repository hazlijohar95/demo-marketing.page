...
// src/lib/ParticleReveal — WebGL React build) — Copyright (c) 2026
// David Haz, MIT + Commons Clause. Ported from TSX to JSX for this
// site's Astro islands. Engine, shaders, and defaults are unchanged
// except: instance setup/teardown runs in an isomorphic layout effect
// (instead of a passive effect) so the first GL frame paints before the
// browser's first paint — no one-frame flash of empty canvas when the
// island hydrates. No dependencies for this WebGL build.
"use client"
